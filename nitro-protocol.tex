...
Do do this, the guarantee provides a list of addresses, with the rule that these addresses will be moved to the top of the priority order if they appear in the outcome.
For example, if a guarantee lists the addresses $(A, B, C)$ and the outcome is $\alloc{C: 1, D:2, A:4}$, then the guarantee will pay out as though the outcome was $\alloc{A:4, C:1, D: 2}$.
...
This will not be a problem for any of the constructions presented in this paper.
