...
\begin{tikzpicture}[y=1.05cm]
  ...
  \node[rotate=30, anchor=north, minimum height=0.4cm] (r1) at (upper2a.south) {};
  \node[rotate=-30, anchor=north, minimum height=0.4cm] (r2) at (upper2b.south) {};

  \draw[-] (r1.north west) to[out=300, in=120] (r1.south west);
  \draw[-] (r1.north) to[out=300, in=120] (r1.south east);
  \draw[-] (r1.north east) to[out=300, in=120] (r1.south);
  \draw[-] (r1.south west) to[out=300, in=90] (lower2.320);
  \draw[-] (r1.south) to[out=300, in=90] (lower2.270);
  \draw[-] (r1.south east) to[out=300, in=90] (lower2.220);

  \draw[-] (r2.north west) to[out=240, in=60] (r2.south);
  \draw[-] (r2.north) to[out=240, in=60] (r2.south east);
  \draw[-] (r2.north east) to[out=240, in=60] (r2.south west);
  \draw[-] (r2.south west) to[out=240, in=90] (lower2.320);
  \draw[-] (r2.south) to[out=240, in=90] (lower2.270);
  \draw[-] (r2.south east) to[out=240, in=90] (lower2.220);

  \pgfmathsetmacro{\angle}{60};
  \pgfmathsetmacro{\inradius}{3};
  \pgfmathsetmacro{\separation}{1};

  \coordinate (incenter) at (5, 0);
  ...
  \draw[-] (rightp1) to[out={180+\angle}, in=90] (basep1);
  \draw[-] (rightp2) to[out={180+\angle}, in=90] (basep2);
  \draw[-] (rightp3) to[out={180+\angle}, in=90] (basep3);
